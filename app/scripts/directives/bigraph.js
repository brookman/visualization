...
angular.module('visApp')
  .directive('bigraph', function (d3Service, $window) {
    return {
      restrict: 'E',
      scope: {
        data: '='
      ...
      link: function (scope, element) {
          ...
          scope.render = function () {
            ...
            if (scope.data) {
              ...
              angular.forEach(scope.data, function (person) {
                angular.forEach(person.interests, function (interest) {
                  interestsData.push([person.name, interest, 1]);
                });
              });
            }
            ...
            var data = [
              {
                data: bP.partData(interestsData, 2),
                id: 'interests',
                header: ['Person', 'Interest', 'Person to Interest Bigraph']
              }
            ];

            var height = 610, margin = {b: 0, t: 40, l: 320, r: 50};
        ...
        function createBP(d3) {
          var bP = {};
          var b = 30, bb = 300, height = 600, buffMargin = 1, minHeight = 14;
          var c1 = [-300, 40], c2 = [-60, 250], c3 = [-10, 300]; //Column positions of labels.
