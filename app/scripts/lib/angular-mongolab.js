angular.module('mongolabResourceHttp', [])
  .factory('$mongolabResourceHttp', ['MONGOLAB_CONFIG', '$http', '$location', function (MONGOLAB_CONFIG, $http, $location) {
    ...
    function MmongolabResourceFactory(collectionName) {
      ...
      var getDefaultParams = function () {
        return {apiKey: $location.search().apiKey};
      };
      ...
      Resource.query = function (queryJson, options) {
        ...
        var requestParams = angular.extend({}, getDefaultParams(), preparyQueryParam(queryJson), prepareOptions(options));
      ...
      Resource.count = function (queryJson) {
        return $http.get(collectionUrl, {
          params: angular.extend({}, getDefaultParams(), preparyQueryParam(queryJson), {c: true})
      ...
      Resource.getById = function (id) {
        return $http.get(collectionUrl + '/' + id, {params: getDefaultParams()}).then(resourceRespTransform);
      };
      ...
      Resource.prototype.$save = function () {
        return $http.post(collectionUrl, this, {params: getDefaultParams()}).then(resourceRespTransform);
      };

      Resource.prototype.$update = function () {
        return $http.put(collectionUrl + '/' + this.$id(), angular.extend({}, this, {_id: undefined}), {params: getDefaultParams()})
      ...
      Resource.prototype.$remove = function () {
        return $http['delete'](collectionUrl + '/' + this.$id(), {params: getDefaultParams()}).then(resourceRespTransform);
      };
